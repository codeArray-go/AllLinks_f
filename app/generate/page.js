...
function GeneratePageContent() {
  ...
  const submitlinks = async () => {
    ...
    const out = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/updateProfile`,
      requestOptions
    );
      ...
      <div className="generate grid grid-cols-2 text-white">
        ...
        <div className="col1 flex justify-center items-end flex-col w-full pt-5">
          <div className="flex flex-col gap-3">
            ...
            <div className="item">
              <h2 className={`${rub.className} font-medium`}>
              ...
              <div className="mx-2">
                <input
                  ...
                  value={handle || ""}
                  className="bg-white text-zinc-950 px-4 py-2 focus:outline-4 focus:outline-pink-200 rounded-lg my-2 mx-2 imput"
                  type="text"
              ...
              {links.map((item, index) => (
                <div key={index} className="mx-2">
                  <input
                    ...
                    className="bg-white px-4 py-2 focus:outline-4 focus:outline-pink-200 rounded-lg my-2 mx-2 text-zinc-950"
                    type="text"
            ...
            <div className="item">
              <h2 className={`${rub.className}`}>
                Step 3: Add a Profile picture and finalize
              </h2>
              <div className="mx-2 flex flex-col">
                ...
                <div className="my-5 flex flex-col">
                  <label htmlFor="textarea">
                    Enter Description for this collection:
                  </label>
                  <textarea
                    value={description}
                    onChange={(e) => setDescription(e.target.value)}
                    className="bg-white px-4 py-1 focus:outline-4 focus:outline-pink-200 rounded-lg my-1 mx-2 text-zinc-950"
                ...
                <button
                  ...
                  onClick={submitlinks}
                  className="disabled:bg-slate-400 p-2 px-3 text-sm mx-2 bg-zinc-900 text-white rounded-lg font-medium cursor-pointer"
                >
                  Create
                </button>
              </div>
